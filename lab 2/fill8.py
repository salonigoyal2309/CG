...
def fill4(win,coords):
	...
	while len(stack)!=0:
		...
		if fill[x+1][y+1]==0 and poly.arr[x+1][y+1]==0 and poly.arr[x+1][y]==0 and poly.arr[x][y+1]==0:
			stack.append((x+1,y+1))
				
		if fill[x][y+1]==0 and poly.arr[x][y+1]==0 :
			stack.append((x,y+1))

		if fill[x-1][y+1]==0 and poly.arr[x-1][y+1]==0 and poly.arr[x][y+1]==0 and poly.arr[x-1][y]==0:
			stack.append((x-1,y+1))
